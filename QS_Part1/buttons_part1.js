...
function AddButtons()
{
	...
	btn_device_polar_0 = new Btn2("0°", "140px", "220px" );
	btn_device_polar_30 = new Btn2("30°", "140px", "240px" );
	btn_device_polar_45 = new Btn2("45°", "140px", "260px" );
	btn_device_polar_60 = new Btn2("60°", "140px", "280px" );
	btn_device_polar_90 = new Btn2("90°", "140px", "300px" );
	btn_device_polar_120 = new Btn2("120°", "140px", "320px" );
	btn_device_polar_150 = new Btn2("150°", "140px", "340px" );
	btn_device_polar_180 = new Btn2("180°", "140px", "360px" );
	...
	btn_device_az_0 = new Btn2("0°", "195px", "220px" );
	btn_device_az_30 = new Btn2("30°", "195px", "240px" );
	btn_device_az_45 = new Btn2("45°", "195px", "260px" );
	btn_device_az_60 = new Btn2("60°", "195px", "280px" );
	btn_device_az_90 = new Btn2("90°", "195px", "300px" );
	btn_device_az_120 = new Btn2("120°", "195px", "320px" );
	btn_device_az_150 = new Btn2("150°", "195px", "340px" );
	btn_device_az_180 = new Btn2("180°", "195px", "360px" );
	btn_device_az_270 = new Btn2("270°", "195px", "380px" );
...
function device_az_0() 
{
	...
	gui.updateDisplay();
	az_background();
	btn_device_az_0.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_30() 
{
	azimuth = 30 * DEGREE;
	recalc();
	controller.azimuth = 30;
	gui.updateDisplay();
	az_background();
	btn_device_az_30.id.style.background = '#ffaaaa';
	axis_rotation();
}
...
function device_az_45() 
{
	azimuth = 45 * DEGREE;
	recalc();
	controller.azimuth = 45;
	gui.updateDisplay();
	az_background();
	btn_device_az_45.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_60() 
{
	azimuth = 60 * DEGREE;
	recalc();
	controller.azimuth = 60;
	gui.updateDisplay();
	az_background();
	btn_device_az_60.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_90() 
{
	azimuth = 90 * DEGREE;
	recalc();
	controller.azimuth = 90;
	gui.updateDisplay();
	az_background();
	btn_device_az_90.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_120() 
{
	azimuth = 120 * DEGREE;
	recalc();
	controller.azimuth = 120;
	gui.updateDisplay();
	az_background();
	btn_device_az_120.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_150() 
{
	azimuth = 150 * DEGREE;
	recalc();
	controller.azimuth = 150;
	gui.updateDisplay();
	az_background();
	btn_device_az_150.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_180() 
{
	...
	gui.updateDisplay();
	az_background();
	btn_device_az_180.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_az_270() 
{
	azimuth = 270 * DEGREE;
	recalc();
	controller.azimuth = 270;
	gui.updateDisplay();
	az_background();
	btn_device_az_270.id.style.background = '#ffaaaa';
	axis_rotation();
}
///////////////////////////////////
function device_polar_0() 
{
	...
	gui.updateDisplay();
	polar_background();
	btn_device_polar_0.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_polar_30() 
{
	...
	gui.updateDisplay();
	polar_background();
	btn_device_polar_30.id.style.background = '#ffaaaa';
	axis_rotation();
}
...
{ 
	...
	gui.updateDisplay();
	polar_background();
	btn_device_polar_45.id.style.background = '#ffaaaa';
	axis_rotation();
}
...
{	
	...
	gui.updateDisplay();
	polar_background();
	btn_device_polar_60.id.style.background = '#ffaaaa';
	axis_rotation();
}
...
{ 
	...
	gui.updateDisplay();
	polar_background();
	btn_device_polar_90.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_polar_120() 
{
	polar = 120 * DEGREE;
	recalc();
	controller.polar = 120;
	gui.updateDisplay();
	polar_background();
	btn_device_polar_120.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_polar_150() 
{
	polar = 150 * DEGREE;
	recalc();
	controller.polar = 150;
	gui.updateDisplay();
	polar_background();
	btn_device_polar_150.id.style.background = '#ffaaaa';
	axis_rotation();
}
function device_polar_180() 
{
	polar = 180 * DEGREE;
	recalc();
	controller.polar = 180;
	gui.updateDisplay();
	polar_background();
	btn_device_polar_180.id.style.background = '#ffaaaa';
	axis_rotation();
}
...
{
	var color = '#ccccff';
	btn_device_az_0.id.style.background = color;
	btn_device_az_30.id.style.background = color;
	btn_device_az_45.id.style.background = color;
	btn_device_az_60.id.style.background = color;
	btn_device_az_90.id.style.background = color;
	btn_device_az_120.id.style.background = color;
	btn_device_az_150.id.style.background = color;
	btn_device_az_180.id.style.background = color;
	btn_device_az_270.id.style.background = color;
}

function polar_background()
{
	var color = '#ccccff';
	btn_device_polar_0.id.style.background = color;
	btn_device_polar_30.id.style.background = color;
	btn_device_polar_45.id.style.background = color;
	btn_device_polar_60.id.style.background = color;
	btn_device_polar_90.id.style.background = color;
	btn_device_polar_120.id.style.background = color;
	btn_device_polar_150.id.style.background = color;
	btn_device_polar_180.id.style.background = color;
}
